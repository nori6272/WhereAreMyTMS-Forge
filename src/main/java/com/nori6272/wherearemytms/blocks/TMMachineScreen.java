...
import com.nori6272.wherearemytms.TMMessage;
...
public class TMMachineScreen extends AbstractContainerScreen<TMMachineScreenHandler> {
    ...
    public static final ResourceLocation battleInfoBase = WhereAreMyTMs.prefix("textures/gui/battle_info_base.png");
    public static final ResourceLocation battleInfoUnderlay = WhereAreMyTMs.prefix("textures/gui/battle_info_underlay.png");
    ...
    protected void renderBg(GuiGraphics gui, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        gui.blit(battleInfoBase, x, y, 0, 0, imageWidth, imageHeight);
    }


    @Override
    public void render(@NotNull GuiGraphics gui, int mouseX, int mouseY, float pPartialTick) {
